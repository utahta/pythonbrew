...
import mimetypes
import re
from pvm.util import makedirs, symlink, Package, is_url, Link,\
...
from pvm.define import PATH_BUILD, PATH_DISTS, PATH_PYTHONS,\
...
from pvm.downloader import get_python_version_url, Downloader,\
    get_headerinfo_from_url
from pvm.log import logger
from pvm.exceptions import UnknownVersionException,\
...
class PythonInstaller(object):
    ...
    def install(self):
        ...
        logger.info("  pvm switch %s" % self.pkg.alias)
